...
data1 = np.load("plt/data/n3-e2-contact.txt.npy")
data2 = np.load("plt/data/n5-e2-contact.txt.npy")
data3 = np.load("plt/data/n3-e2-dipole-0.060.txt.npy")
data4 = np.load("plt/data/n5-e2-dipole-0.060.txt.npy")
